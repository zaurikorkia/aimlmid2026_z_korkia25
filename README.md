...
**Explanation:** Contains many capital words (URGENT, Congratulations, Claim), spam indicators (Won, Prize), and an external link → high values for spam_word_count and links.
...
**Explanation:** Normal business language, no external links, very few capital words, no spam