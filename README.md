...
Pearson’s correlation coefficient was calculated using Python and pandas corr() method.  
The source code used for this task is:  
...
**Visualization**  
The scatter plot below shows the collected data points and a linear trend line.
...
**Dataset**  
The dataset used for this task is provided by the instructor and contains email features and their classes (spam or legitimate).  
Dataset file: `Spam email detection/z_korkia25_75869.csv`
...
A Python console application was created using Logistic Regression.  
Main script: `Spam email detection/spam_classifier.py`

The application performs the following steps:  
- Loads and processes the dataset  
- Splits the data into 70% training and 30% testing sets  
- Trains a Logistic Regression model  
- Validates the model using Confusion Matrix and Accuracy  
- Classifies new feature vectors as spam or legitimate  
...
[[353  15]   ← Legitimate
 [ 22 360]]  ← Spam
Accuracy: 95.07%
This shows that the model performs very well with a small number of misclassifications.
Email Classification Function
The function classify_email(feature_vector) accepts features in order:
...
Reason: Contains many spam keywords, urgency phrases, capital words and an external link.
...
Reason: Normal professional language, no links, no spam keywords, no excessive capitalization.
Visualizations
1. Class Distribution
The following chart shows the distribution of spam and legitimate emails in the dataset.
Class distribution
